...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-10 lg:left-[30rem] transform lg:translate-x-1/2 translate-x-1/3 translate-y-1/2 z-50 bg-[#0f0f0f] border lg:w-[30%] w-[60%] px-[4rem] mb-[2rem] rounded">
